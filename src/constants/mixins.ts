...
export const scaleSize = (size: number) => (WINDOW_WIDTH / GUIDELINE_BASE_WIDTH) * size;

export const responsiveScale = (fontSize: number) =>
...
export function boxShadow(offset = { height: 2, width: 2 }, opacity = 0.2, radius = 8, color) {
  return {
    shadowOffset: offset,
...
export function centerVertical(blockHeight: number) {
